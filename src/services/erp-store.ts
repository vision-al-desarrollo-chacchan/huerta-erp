...
export type Employee = { id: string; dni: string | null; nombres: string; apellidos: string; cargo: string; area: string; telefono: string | null; email: string | null; fecha_ingreso: string; sueldo: number; estado: 'activo' | 'inactivo'; acceso_rol?: 'cajero' | 'mozo' | 'moza_cajera' | 'cocina' | 'supervisor' | null; pin_actualizado_at?: string | null; created_at: string };
